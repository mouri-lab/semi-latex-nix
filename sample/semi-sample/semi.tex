...
\section{図の挿入方法}
\subsection{通常の画像ファイル}
通常の画像ファイル（png, jpg）は，includegraphicsコマンドで挿入します（例: 図\ref{fig:normal-sample}）．

\begin{figure}[t]
	\centering
	\includegraphics[width=8cm]{fig/normal-sample.png}
	\caption{通常の画像ファイル}
	\label{fig:normal-sample}
\end{figure}
